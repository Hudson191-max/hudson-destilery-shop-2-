    ...
    <div>
      ...
      <div className="card payroll-filters">
        ...
        <div className="payroll-quick-buttons">
          <button className="btn btn-sm" onClick={() => setQuickRange("today")}>
            Today
          </button>
          <button className="btn btn-sm" onClick={() => setQuickRange("week")}>
            7 days
          </button>
          <button className="btn btn-sm" onClick={() => setQuickRange("month")}>
            This month
          </button>
          <button className="btn btn-sm" onClick={() => setQuickRange("all")}>
            All time
          </button>
        </div>
        <div className="payroll-filter-group payroll-rate">
          <label>Rate per unit ({CURRENCY})</label>
          <input
            type="number"
            min={0}
            step="0.01"
